...
/**
 * @coversDefaultClass \Mxgma\SwissBankPayment\PaymentInformation\PaymentInformation
 */
class PaymentInformationTest extends TestCase
{
    ...
    public function testInvalidDebtorAgent()
    {
        ...
        $debtorAgent = $this->getMock('\Mxgma\SwissBankPayment\FinancialInstitutionInterface');
